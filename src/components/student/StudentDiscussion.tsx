...
export function StudentDiscussions({ user }: StudentDiscussionsProps) {
  ...
  const filteredDiscussions = myDiscussions.filter(
    (disc) =>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 italic">
            Trao đổi và thảo luận với giảng viên, bạn bè
          </p>
        </div>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                <Label className="font-semibold">Lớp học</Label>
                <Select
                  value={newDiscussion.courseId}
                  onValueChange={(value: string) =>
                    setNewDiscussion({ ...newDiscussion, courseId: value })
                  }
                >
                  <SelectTrigger>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    {course && (
                      <Badge
                        variant="outline"
                        className="mt-2 border-primary text-primary font-semibold"
                      >
                        {course.name}
                      </Badge>
                    )}
